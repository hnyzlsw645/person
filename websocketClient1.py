...
import websockets
import platform
from WebSocketUtil import WebSocketUtil as WebsocketUtil
...
async def main_logic():
    # async with websockets.connect('ws://127.0.0.1:9090/websocket/'+platform.platform()) as websocket:
        # await auth_system(websocket)
        # await send_msg(websocket)
        websocketUtil = WebsocketUtil()
        await websocketUtil.init()
